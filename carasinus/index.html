...
function draw() {
  ...
  ellipse(300,200,200,250);//Forma de cara exterior
  ...
  ellipse(260,150,35,25);//Forma d'ull dret perquè x=260
    ellipse(340,150,35,25);//Forma d'ull esquqerre perquè x=340
   fill(255, 110, 110);//Color de la boca
  arc(300, 245, 75, 50,0,PI);//Forma de la boca
}
